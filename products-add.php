...
<?php include("header.php") ?>
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input name="typeid" type="text" id="inputClientCompany" class="form-control">              
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input  name="image" type="text" id="inputProjectLeader" class="form-control">
              </div>
              <div class="form-group">
  ...
  <?php if(isset($_POST['submit']))
  {
    ...
    $insertProduct = $Products->insertProduct($name, $manu_id, $type_id, $price, $image, $description, $feature, $created_at);
  }?>
