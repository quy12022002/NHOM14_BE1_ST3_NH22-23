			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						...
						<li><a href="#"><i class="fa fa-envelope-o"></i> liar12022002@gmail.com</a></li>
						<li><a href="#"><i class="fa fa-map-marker"></i> 1734 Stonecoal Road</a></li>
					</ul>
					<ul class="header-links pull-right">
						<li><a href="#"><i class="fa fa-dollar"></i> USD</a></li>
						<?php if(!isset($_SESSION['username'])): ?>
							<li><a href="./login/login.php"><i class="fa fa-user-o"></i> My Account</a></li>	
						<?php else: ?>
							<li><a href="./login/logout.php"><i class="fa fa-sign-out"></i><?= $_SESSION['username'] ?></a></li>	
						<?php endif; ?>		
